...
const string fileBase = "/home/theo/Documents/projects/math/neuralNets/cTensor/src/Data/images/mnist_jpgfiles/train";
const string fileBaseTest = "/home/theo/Documents/projects/math/neuralNets/cTensor/src/Data/images/mnist_jpgfiles/test";
...
int main(int argc, char ** argv){
    ...
    trainingSet testing = uploadAllImages(fileBase, fileNames, labels, 10, "jpg", 10000);
//for(int i = 0; i < testing.files.size(); i++){
//std::cout<<testing.files[i].file<<std::endl;
//}

    int nHL[10] = {1, 1, 1, 1};
    int sHL[10] = {80, 70, 60, 60};
    float rate[10] = {0.007, 0.03, 0.02, 0.02};


    trainingSet testing2 = uploadAllImages(fileBaseTest, fileNames, labels, 10, "jpg", 10000);
...
//        temp.printNetwork();
        ...
        std::cout<<"Layers = "<<nHL[i]<<" Rate = "<<rate[i]<<" nodes = "<<sHL[i]<<std::endl;
