...
UI::neuralNetworkMenu()
{
  ...
  switch (inputS) {
    case 1: {
      ...
      printf("Please note that if a file path is incorrect, unexpected results "
             "may occur (Done my best to conteract this, but stuff happens\n");
      printf("First, Enter training directory (no need to end in a /): \n>> ");
      std::cin.ignore();
      getline(std::cin, trainingFileBase);
      if (trainingFileBase.empty()) {
        //                trainingFileBase =
        //                "/home/theo/Documents/projects/math/neuralNets/cTensor/src/Data/images/mnist_jpgfiles/train";
      ...
      if (testingFileBase.empty()) {
        //                testingFileBase =
        //                "/home/theo/Documents/projects/math/neuralNets/cTensor/src/Data/images/mnist_jpgfiles/test";
      ...
      printf("For reference:\nLayers = 1 Rate = 0.008 nodes = 600\nAccuracy = "
             "0.4839\n");
      printf("Layers = 2 Rate = 0.009 nodes = 320\nAccuracy = 0.9123 (takes 12 "
             "hours)\n");
      printf("Short (under 10 minutes) training sessions typically get around "
             "0.3 - 0.4\n");
      printf("Longer training sessions on looping recursive image batch "
             "produces max 0.91\n");
...
// main propogation
void
UI::propogateNeuralNetwork(const char** fileNames, int* labels)
{

  trainingSet testing = uploadAllImages(
    trainingFileBase, fileNames, labels, numLabels, fileEnding, numReps);
...
UI::mainDisplay()
{
  ...
  // printf("       ooooo                                  \n         8 \n.oPYo.
  // 8   .oPYo. odYo. .oPYo. .oPYo. oPYo.\n8    '   8   8oooo8 8' `8 Yb..   8 8
  // 8
  // `' \n8    .   8   8.     8   8   'Yb. 8    8 8     \n`YooP'   8   `Yooo' 8
  // 8 `YooP' `YooP' 8
  // \n:.....:::..:::.....:..::..:.....::.....:..::::\n::::::::::::::::::::::::::::::::::::::::::::::\n:::::::::::::::::::::::::::::::::::::::::::::\n");
...
bool
UI::controlFlow(const char** fileNames, int* labels)
{
  mainDisplay();
  int i = 0;
  i = Menu();
  ...
  if (i == 1) {
    ...
    trainingSet testing2 = uploadAllImages(
      testingFileBase, fileNames, labels, numLabels, "jpg", 100);
...
//================================
void
UI::addMatrix(string matrixIn, string id)
{
  if (head == nullptr) {
...
Matrix
UI::multiplyMatrices(string id1, string id2)
{
